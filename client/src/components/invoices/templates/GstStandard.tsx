...
const styles = StyleSheet.create({
  page: { padding: '10mm', fontSize: 7, fontFamily: 'Helvetica', color: COLORS.black, backgroundColor: COLORS.white },
  container: { border: '1pt solid ' + COLORS.border, flexDirection: 'column', width: '100%' },
  ...
  gstinLineContainer: { marginTop: 2, paddingTop: 3, borderTop: '0.5pt solid ' + COLORS.border, alignSelf: 'center', width: '100%' },
  gstinText: { fontSize: 9, fontWeight: 'bold', textAlign: 'center' },
  invoiceTitleBar: { backgroundColor: COLORS.headerBg, borderBottom: '1pt solid ' + COLORS.border, textAlign: 'center', paddingVertical: 1.5, fontWeight: 'bold', fontSize: 8, textTransform: 'uppercase' },
  metaGrid: { flexDirection: 'column', borderBottom: '1pt solid ' + COLORS.border },
  metaInnerRow: { flexDirection: 'row', borderBottom: '1pt solid ' + COLORS.border },
  metaCol: { width: '50%' },
  metaItem: { flexDirection: 'row', borderBottom: '1pt solid ' + COLORS.border, height: 14, alignItems: 'center' },
  metaItemLast: { flexDirection: 'row', height: 14, alignItems: 'center' },
  metaLabel: { width: 90, paddingHorizontal: 4, fontWeight: 'bold', borderRight: '1pt solid ' + COLORS.border, fontSize: 8 },
  metaValue: { flex: 1, paddingHorizontal: 4, fontSize: 8 },
  msmeFullRow: { flexDirection: 'row', height: 15, alignItems: 'center' },
  msmeLabel: { paddingHorizontal: 4, fontWeight: 'bold', borderRight: '1pt solid ' + COLORS.border, fontSize: 8, width: 150 },
  partyHeaderGrid: { flexDirection: 'row', backgroundColor: COLORS.headerBg, borderBottom: '1pt solid ' + COLORS.border },
  partyHeaderCell: { width: '50%', textAlign: 'center', paddingVertical: 2, fontWeight: 'bold', fontSize: 8 },
  partyDataGrid: { flexDirection: 'row', borderBottom: '1pt solid ' + COLORS.border, minHeight: 65 },
  partyBox: { width: '50%', padding: 4 },
  partyLine: { flexDirection: 'row', marginBottom: 1, fontSize: 8 },
  partyLabel: { fontWeight: 'bold', width: 45 },
  partyValue: { flex: 1 },
  descHeaderLine: { padding: 3, fontSize: 7, borderBottom: '1pt solid ' + COLORS.border },
  table: { flexDirection: 'column' },
  tableHeader: { flexDirection: 'row', backgroundColor: COLORS.headerBg, borderBottom: '1pt solid ' + COLORS.border, fontWeight: 'bold', textAlign: 'center', fontSize: 7 },
  tableRow: { flexDirection: 'row', borderBottom: '0.5pt solid ' + COLORS.border, height: 12, alignItems: 'center', textAlign: 'center', fontSize: 7 },
  tableTotalRow: { flexDirection: 'row', backgroundColor: COLORS.headerBg, borderBottom: '1pt solid ' + COLORS.border, height: 16, alignItems: 'center', textAlign: 'center', fontWeight: 'bold', fontSize: 7 },
  ...
  summaryHeaderRow: { flexDirection: 'row', backgroundColor: COLORS.headerBg, borderBottom: '1pt solid ' + COLORS.border },
  summaryHeaderLeft: { width: '65%', textAlign: 'center', paddingVertical: 2, fontWeight: 'bold', fontSize: 8, borderRight: '1pt solid ' + COLORS.border },
  summaryDataGrid: { flexDirection: 'row', borderBottom: '1pt solid ' + COLORS.border },
  summaryWordsBox: { width: '65%', borderRight: '1pt solid ' + COLORS.border, justifyContent: 'center', alignItems: 'center', padding: 10 },
  summaryWordsText: { fontSize: 11, fontStyle: 'italic', fontWeight: 'bold', textAlign: 'center' },
  summaryTotalsBox: { width: '35%' },
  totalsRow: { flexDirection: 'row', borderBottom: '1pt solid ' + COLORS.border, height: 14, alignItems: 'center' },
  totalsLabel: { width: '65%', paddingHorizontal: 4, fontWeight: 'bold', borderRight: '1pt solid ' + COLORS.border, fontSize: 7 },
  ...
  footerBankBox: { width: '35%', borderRight: '1pt solid ' + COLORS.border },
  footerSealBox: { width: '20%', borderRight: '1pt solid ' + COLORS.border, justifyContent: 'center', alignItems: 'center' },
  footerSignBox: { width: '45%', padding: 5, justifyContent: 'space-between' },
  bankHeader: { backgroundColor: COLORS.headerBg, borderBottom: '1pt solid ' + COLORS.border, textAlign: 'center', paddingVertical: 1.5, fontWeight: 'bold', fontSize: 8 },
  ...
  termsBox: { borderTop: '1pt solid ' + COLORS.border, textAlign: 'center', paddingVertical: 2, fontWeight: 'bold', fontSize: 7, marginTop: 'auto' },
  ...
  signatureHLine: { marginTop: 20, borderTop: '1pt solid ' + COLORS.border, width: '80%', alignSelf: 'center' },
          ...
          <View style={styles.metaGrid}>
            <View style={styles.metaInnerRow}>
              <View style={[styles.metaCol, { borderRight: '1pt solid ' + COLORS.border }]}>
                ...
                <View style={styles.metaItemLast}><Text style={styles.metaLabel}>State:</Text><Text style={styles.metaValue}>{invoiceData.seller.state} | Code: {invoiceData.seller.stateCode}</Text></View>
              </View>
