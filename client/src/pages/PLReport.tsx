    ...
    <div className="space-y-6 print:p-0 print:space-y-4">
      <div className="flex justify-between items-end print:hidden">
        <div>
          ...
          <p className="text-[14px] text-text-muted mt-1 uppercase tracking-widest font-black">Fiscal Performance Tracking · Generic Business View</p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="card flex flex-col justify-center border-border/40 min-h-[100px]">
           <div className="text-[13px] text-text-muted uppercase tracking-widest font-semibold">Gross Income</div>
           <div className="text-xl font-bold text-text-primary mt-2">₹{pl.income.total?.toLocaleString() || 0}</div>
        </div>
        <div className="card flex flex-col justify-center border-border/40 min-h-[100px]">
           <div className="text-[13px] text-text-muted uppercase tracking-widest font-semibold">Total Operating Costs</div>
           <div className="text-xl font-bold text-text-primary mt-2">₹{pl.expenses.total?.toLocaleString() || 0}</div>
        </div>
        <div className="card flex flex-col justify-center border-border/40 min-h-[100px]">
           <div className="text-[13px] text-text-muted uppercase tracking-widest font-semibold">Tax Liability (GST/VAT)</div>
        ...
        <div className="card bg-success/10 border-success/30 flex flex-col justify-center min-h-[100px]">
           <div className="text-[13px] text-success uppercase tracking-widest font-semibold">Net Profit (Before Tax)</div>
      ...
      <div className="grid grid-cols-3 gap-6">
         <div className="col-span-2 card border-border/40">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-[17px] font-bold text-text-primary uppercase tracking-tighter">Detailed Operating Statement</h3>
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center py-2.5 border-b border-border text-[15px]">
              ...
              <div className="flex justify-between items-center py-3 text-[14px] font-semibold uppercase tracking-widest text-text-primary bg-bg-surface-2 px-3 rounded-lg mt-2">
              ...
              <div className="flex justify-between items-center py-2 border-b border-border text-[15px]">
              ...
              <div className="flex justify-between items-center p-4 bg-bg-surface-2 rounded-xl border border-border">
                <div className="flex flex-col">
                  <span className="text-[13px] text-text-primary uppercase font-black tracking-widest">Net Operating Profit</span>
         ...
         <div className="space-y-6">
            <div className="card border-border/40">
               <div className="flex items-center gap-2 mb-6">
                  ...
                  <h3 className="text-[16px] font-bold text-text-primary uppercase">Tax Summary</h3>
               </div>
               
                <div className="space-y-4">
                   <div className="flex justify-between items-end border-b border-border pb-3">
                      <div className="flex flex-col">
                         <span className="text-[13px] text-text-muted font-semibold uppercase">CGST / Primary Tax</span>
                         <span className="text-[15px] font-medium text-text-primary mt-1">Output Collected</span>
                      </div>
                      <span className="text-[16px] font-bold text-accent-orange">₹{gst.collected.cgst?.toLocaleString() || 0}</span>
                   </div>
                   <div className="flex justify-between items-end border-b border-border pb-3">
                      <div className="flex flex-col">
                         <span className="text-[13px] text-text-muted font-semibold uppercase">SGST / Secondary Tax</span>
                         <span className="text-[15px] font-medium text-text-primary mt-1">Output Collected</span>
                      </div>
                      <span className="text-[16px] font-bold text-accent-orange">₹{gst.collected.sgst?.toLocaleString() || 0}</span>
                   </div>
                   <div className="flex justify-between items-end border-b border-border pb-3">
                      <div className="flex flex-col">
                         <span className="text-[13px] text-text-muted font-semibold uppercase">IGST / Custom Tax</span>
                         <span className="text-[15px] font-medium text-text-primary mt-1">International/Inter-state</span>
                      </div>
                      <span className="text-[16px] font-bold text-accent-orange">₹{gst.collected.igst?.toLocaleString() || 0}</span>
                   </div>
                   
                   <div className="p-3 bg-bg-surface-2 rounded-lg mt-4">
                      <div className="flex justify-between text-[14px] font-bold text-text-primary uppercase tracking-tighter">
                ...
                <div className="card bg-gradient-to-r from-accent-blue/10 to-accent-purple/10 border-accent-blue/30 shadow-xl shadow-accent-blue/10">
                   <div className="text-[13px] text-accent-blue font-semibold uppercase tracking-widest mb-1 flex items-center gap-2">
                   ...
                   <p className="text-[13px] text-text-muted mt-3 italic font-medium leading-tight">Consolidated Financial Performance</p>
                </div>
         </div>
      </div>
    </div>
