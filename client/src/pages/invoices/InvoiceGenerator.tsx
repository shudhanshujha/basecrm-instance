                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={`px-3 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${!isCustomNumber ? 'bg-accent-orange text-white' : 'bg-bg-surface-2 text-text-muted border border-border'}`}
                    >Auto</button>
                    <button
                  ...
                  {isCustomNumber ? (
                    ...
                    <div className="flex gap-2 items-center">
                      <input type="text" className="w-full bg-bg-surface border border-border rounded-xl px-3 py-2 text-[13px] outline-none font-bold text-accent-blue" value={formData.invoiceNumber} readOnly />
                      <button
                        onClick={async () => {
                          try {
